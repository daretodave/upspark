...
export namespace PlatformBootstrapper {
    export const load = (resources:Resource, updateEmitter:CommandUpdateEmitter):Promise<Platform> => {
        return new PlatformBootstrapper(resources).load(updateEmitter);
    }
}